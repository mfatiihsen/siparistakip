    ...
    <main class="container mt-5">
        <?php if ($siparis): ?>
            ...
            <div class="order-details-container">
                ...
                <a style="text-decoration: none;" href="../index.php"><p class="backAna">Ana Sayfaya Dön</p></a>
...
<script>
    ...
    if (value == "TESLİM EDİLDİ") {
        document.getElementById('info-baslik').innerHTML = "Siparişiniz kuryemiz tarafından teslim edilmiştir.";
        ...
        document.getElementById('teslimedildi').src = "images/icons/teslimedildigreen.png";
        document.getElementById('dagitimda').src = "images/icons/dagitimdaorange.png";
        document.getElementById('teslimalindi').src = "images/icons/teslimalindired.png";
        document.getElementById('yolda').src = "images/icons/yoldablue.png";
    }

    if (value == "TESLİM ALINDI") {
        document.getElementById('info-baslik').innerHTML = "Siparişiniz şubemiz tarafından teslim alınmıştır.";
        document.getElementById('teslimalindi').src = "images/icons/teslimalindired.png";
        document.getElementById('dagitimda').src = "images/icons/dagitimda.png";
        document.getElementById('teslimedildi').src = "images/icons/teslimedildi.png";
        document.getElementById('yolda').src = "images/icons/yolda.png";
    }


    if (value == "DAĞITIMDA") {
        document.getElementById('info-baslik').innerHTML = "Siparişiniz kuryemiz tarafından dağıtıma çıkarılmıştır.";
        document.getElementById('cizgi2').style.backgroundColor = "#FCC419";
        document.getElementById('cizgi1').style.backgroundColor = "#339AF0";
        document.getElementById('dagitimda').src = "images/icons/dagitimdaorange.png";
        document.getElementById('teslimalindi').src = "images/icons/teslimalindired.png";
    ...
    if (value == "YOLDA") {
        document.getElementById('info-baslik').innerHTML = "Siparişiniz transfer aşamasındadır.";
        document.getElementById('cizgi1').style.backgroundColor = "#339AF0";
        document.getElementById('yolda').src = "images/icons/yoldablue.png";
        document.getElementById('dagitimda').src = "images/icons/dagitimda.png";
        document.getElementById('teslimedildi').src = "images/icons/teslimedildi.png";
